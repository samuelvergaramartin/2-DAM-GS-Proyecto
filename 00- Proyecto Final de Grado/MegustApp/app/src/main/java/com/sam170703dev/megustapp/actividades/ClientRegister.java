...
public class ClientRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText usuarioInput = findViewById(R.id.usuario_client_register);
        final EditText correoInput = findViewById(R.id.correo_client_register);
        final EditText claveInput = findViewById(R.id.clave_client_register);
        final EditText confirmarClaveInput = findViewById(R.id.confirmar_clave_client_register);
        final Button botonSiguiente = findViewById(R.id.boton_siguiente_client_register);
        final TextView textoVolverAtras = findViewById(R.id.texto_volver_atras_client_register);
                    ...
                    if(contieneCaracteresInvalidos) {
                        ...
                        if(!caracteresCorreo.contains('@') || !caracteresCorreo.contains('.')) {
                            ...
                            if(claveInput.getText().toString().equals(confirmarClaveInput.getText().toString())) {
                                ...
                                Toast.makeText(ClientRegister.this, "Los campos de las contraseñas deben ser iguales.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                }
                else {
                    Toast.makeText(ClientRegister.this, "Todos los campos son obligatorios.", Toast.LENGTH_SHORT).show();
                }
            }
        });
